...
<html lang="es">
    ...
    <head>
        ...
        <!-- Vite Assets -->
        @vite(['resources/css/vendor.css', 'resources/css/app.css', 'resources/css/sidebar.css', 'resources/css/modules/pagination.css', 'resources/css/dark-mode.css', 'resources/js/app.js'])
        @stack('styles')
        @stack('scripts')
